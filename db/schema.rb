...
ActiveRecord::Schema.define(version: 2020_03_03_144319) do
  ...
  create_table "meetings", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.text "colleagues", default: [], array: true
    t.integer "duration"
    t.time "endtime"
    t.string "name"
    t.index ["meetingroom_id"], name: "index_meetings_on_meetingroom_id"
  end
  ...
  add_foreign_key "meetings", "meetingrooms"
end
